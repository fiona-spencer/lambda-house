  ...
  <div className="max-w-6xl mx-auto px-6 flex flex-wrap items-center">
    ...
    <Link to="/" className="flex items-center order-1 sm:order-1 w-auto">
      <img
        ...
        className="sm:h-16 h-10 pr-10 w-auto object-contain hover:opacity-50 transition duration-200"
      />
    </Link>
    ...
    {/* User + Cart */}
<div className="flex space-x-4 order-2 sm:order-3 w-auto ml-auto">
  <Dropdown
    inline
    label={
      loggedIn ? (
